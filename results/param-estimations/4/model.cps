  ...
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1550" name="k1" value="9.41411"/>
          <Constant key="Parameter_1549" name="k2" value="4.66771"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1548" name="k1" value="8.07465"/>
          <Constant key="Parameter_1547" name="k2" value="0.790523"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1546" name="k1" value="8.55649"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1545" name="k1" value="33.8233"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1544" name="k1" value="9.81867"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1543" name="k" value="2.58296"/>
          <Constant key="Parameter_1542" name="K_act" value="2.40251"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1541" name="k1" value="0.48977"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_10">
    ...
    <InitialState type="initialState">
      0 0 0 1134571.513236 113.4571513236 0 0 340371.4539708 0 453828.6052944 260951448.04428 111070.5262915434 3562.55455156104 3.768e-12 1 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="2.402513626680338"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="2.582957006378946"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="8.556494936045207"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.414106631137875"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="4.66771467304414"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="33.82331644827796"/>
            <Parameter name="UpperBound" type="cn" value="50"/>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="8.074649608986558"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.7905229578549787"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.4897696847819316"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.81866999013455"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.0489482262668267"/>
