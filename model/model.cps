...
<!-- generated with COPASI 4.8 (Build 35) (http://www.copasi.org) at 2013-01-30 11:25:47 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <Model key="Model_0" name="PI3K signalling pathway" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="µmol" type="deterministic" avogadroConstant="6.02214e+23">
    <MiriamAnnotation>
<rdf:RDF
...
k2 = 0.0038 1/s
        ...
        <ListOfConstants>
          <Constant key="Parameter_1633" name="k1" value="29"/>
          <Constant key="Parameter_1634" name="k2" value="0.022"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1635" name="k1" value="9.85524"/>
          <Constant key="Parameter_1638" name="k2" value="2.05313"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1637" name="k1" value="0.272153"/>
          <Constant key="Parameter_1639" name="k2" value="0.417346"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1636" name="k1" value="10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1640" name="k1" value="11.7289"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1641" name="k1" value="0.779595"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <dcterms:creator>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1642" name="k" value="4.35658"/>
          <Constant key="Parameter_1643" name="K_act" value="9.32877"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1644" name="k1" value="0.182126"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1645" name="k1" value="10"/>
          <Constant key="Parameter_1646" name="k2" value="0.3"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1647" name="k1" value="1.33"/>
          <Constant key="Parameter_1648" name="k2" value="0.08"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_1649" name="v" value="5e-05"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 0 0 1134571.513236 113.4571513236 0 0 340371.4539708 0 453828.6052944 260951448.04428 1180480.418025113 3562.55455156104 1 3.768e-12 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_8" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_4" target="parameter_scan.txt" append="0"/>
      <Problem>
    ...
    <Task key="Task_5" name="Parameter Estimation" type="parameterFitting" scheduled="true" updateModel="true">
      <Report reference="Report_4" target="param_est_report.txt" append="1"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.32877"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="4.35658"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.85524"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="2.05313"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="11.7289"/>
            <Parameter name="UpperBound" type="cn" value="50"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
            ...
            <Parameter name="StartValue" type="float" value="0.272153"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.417346"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.182126"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
            ...
            <Parameter name="StartValue" type="float" value="0.779595"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
            ...
            <Parameter name="StartValue" type="float" value="0.5202318250782503"/>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="pten_lit">
            ...
            <Parameter name="File Name" type="file" value="experiment/simple/pten_lit.txt"/>
          ...
          <ParameterGroup name="Experiment">
            <Parameter name="Data is Row Oriented" type="bool" value="1"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="File Name" type="file" value="experiment/simple/wt_lit.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
